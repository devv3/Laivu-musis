...
public:
	...
	void p_puol_attack()
	{
		...
		if (cpu_patrol_size == 0 && cpu_patrol_done != 1)
		{
			cout << setw(82) << "Jus nuskandinote kompiuterio patruli";
			Sleep(1000);
			cpu_patrol_done = 1;
			print_pBoard_AttackBoard();
		}
		...
		{
			cout << setw(82) << "Jus nuskandinote kompiuterio lektuvnesi";
			Sleep(1000);
			cpu_carr_done = 1;
			print_pBoard_AttackBoard();
		}
		...
		{
			cout << setw(82) << "Jus nuskandinote kompiuterio naikintoja";
			Sleep(1000);
			cpu_dest_done = 1;
			print_pBoard_AttackBoard();
		}
		...
		{
			cout << setw(82) << "Jus nuskandinote kompiuterio povandenini laiva";
			Sleep(1000);
			cpu_sub_done = 1;
			print_pBoard_AttackBoard();
		}
